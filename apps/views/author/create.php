<div class="container border">
    ...
    <form method="post" action="<?= ROOT; ?>/author/store">
        <div class="mb-3">
            ...
            <input type="text" name="username" class="form-control" id="username" placeholder="Enter Username" pattern="[a-z0-9_@]{5,50}" onkeyup="this.value=this.value.toLowerCase()" onchange="checkUser(this.value,ur)" title="You can Only enter alphanumeric value with _ and @" required>
            <span id="ur"></span>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="form-control" style="display: flex;"><span style="display:block; height:30px; width: 40px; background-color: #bbb; color:blue">+91</span><input type="text" name="mobile" id="mobile" style="border:0 ; outline:0; width:100%" placeholder="Enter Mobile" pattern="[0-9]{10}" title="" required></div>
        </div>
        <div class="mb-3">
